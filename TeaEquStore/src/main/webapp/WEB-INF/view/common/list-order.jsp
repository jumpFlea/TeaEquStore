...
<body class="gray-bg">
                   				...
                   				<form  id="exprot" action="${ctx }/admin/orderInfo/export" method="post">
									...
									<!-- <div class="col-lg-4 form-group">
										<div class="input-group">
											...
											</span><input type="text" id="userSerial" name="userSerial" class="form-control trimInput">
										</div>
									</div>
									<div class="col-lg-4 form-group">
										<div class="input-group">
											...
											</span><input type="text" id="storeName" name="storeName" class="form-control trimInput">
										</div>
									</div> -->
									<div class="col-lg-4 form-group">
										<div class="input-group">
									...
									<div class="col-lg-4 form-group">
										<div class="input-group">
											...
											<select id="isSelf" name="isSelf" class="form-control">
									...
									<div class="col-lg-5 form-group">
										<div class="input-group">
											...
											<input type="text" id="beginCreateTime" name="beginCreateTime" class="form-control">
											<span class="input-group-btn">
												<button tabindex="-1" class="btn btn-white" type="button">--</button>
											</span>
											<input type="text" id="endCreateTime" name="endCreateTime" class="form-control">
									...
									<div class="col-lg-5 form-group">
										<div class="input-group">
											...
											<input type="text" id="beginPayTime" name="beginPayTime" class="form-control">
											<span class="input-group-btn">
												<button tabindex="-1" class="btn btn-white" type="button">--</button>
											</span>
									...
									<div class="col-lg-6 form-group" style="margin-bottom:0px;">
										<input  type="hidden" name="totalResults" id ="totalResults"/>
										<input class="glyphicon-search" type="hidden" name="state" id ="state"/>
		                    			...
		                    			第<input class="form-control trimInput" id="startPage" name="startPage">页至第<input class="form-control trimInput" id="endPage" name="endPage">页
		                    			<input type = "button" class="btn btn-primary btn-outline glyphicon glyphicon-search" id="exportBtn" value = "导出订单" />
	                     	...
	                     	<div class="col-sm-12">
								<div class="tabs-container" style="margin-left: 10px;">			
									<ul class="nav nav-tabs">
					                    <li class="active">
					                        <a data-toggle="tab" id="tab" onclick="getOrderByState(0);" href="#tab-1" aria-expanded="true"> 全部</a>
					                    </li>
					                    <li class="">
					                        <a data-toggle="tab" id="tab1"  onclick="getOrderByState(1);" href="#tab-2" aria-expanded="false">待付款</a>
					                    </li>
					                   <li class="">
					                        <a data-toggle="tab" id="tab3" onclick="getOrderByState(3);" href="#tab-3" aria-expanded="false">配货中</a>
					                    </li>
					                    <li class="">
					                        <a data-toggle="tab" id="tab4" onclick="getOrderByState(4);" href="#tab-4" aria-expanded="false">清关中</a>
					                    </li>
					                    <li class="">
					                        <a data-toggle="tab" id="tab5" onclick="getOrderByState(5);" href="#tab-5" aria-expanded="false">已发货</a>
					                    </li>
					                    <li class="">
					                        <a data-toggle="tab" id="tab6" onclick="getOrderByState(6);" href="#tab-6" aria-expanded="false">已完成</a>
					                    </li>
					                     <li class="">
					                        <a data-toggle="tab" id="tab8" onclick="getOrderByState(8);" href="#tab-7" aria-expanded="false">已归档</a>
					                    </li>
					                    <li class="">
					                        <a data-toggle="tab" id="tab9" onclick="getOrderByState(9);" href="#tab-8" aria-expanded="false">已关闭</a>
					                    </li>				          
					                </ul>
					               <div class="tab-content">
	                    				<div id="tab-1" class="tab-pane active ">
					                        <div class="col-sm-12 m-b order-list-head">
												<div class="col-sm-2">
												<input type="checkbox" style="margin-top: 10px;margin-left: -5px;" class="check-all-btn" id="selectAll" name="selectAll" />
												商品名称</div>
												<div class="col-sm-1"></div>
												<div class="col-sm-1">单价/元*数量</div>
												<div class="col-sm-1">收货人信息</div>
												<div class="col-sm-1">实付款/元</div>
												<div class="col-sm-2">留言</div>
												<div class="col-sm-1">状态</div>
												<div class="col-sm-3">操作</div>
											</div>
											
											<div class="col-sm-12 dataContent" style="padding-left: 0px;padding-right: 0px;">
											</div>
											<div class="col-sm-12">
		                       ...
		                       <span class="input-group-btn">
								...
								<div class="productType-group">
		                      		...
		                      		<input type="hidden" class="productTypeId" name="productTypeId" id="productTypeId">
		                       		...
		                       		<input type="hidden" class="totalResults" value="">
							...
							<tr >
								<th style="text-align:center">
									<div class="checkbox i-checks ids" title="全选/全不选">
                                        <label >
                                            <input type="checkbox" style="margin-top: 3px;margin-left: -18px;" class="check-all-btn" onclick="selectAll(this)" id="select-all-product" name="selectAll" />
                                        </label>
                                    </div>
								</th>
            ...
            <div class="modal-content animated bounceInRight">
                ...
                <div class="modal-body all">
                    <div class="form-group">
				        ...
				        <div class="col-sm-8">
				            <input type="file" id="file" name="file" onchange="ajaxFileUpload2($(this))" />
	...
	<script src="${ctx }/template/hplus/js/plugins/dataTables/jquery.dataTables.js"></script>
    <script src="${ctx }/template/hplus/js/plugins/layer/laydate/laydate.js"></script>
    <script src="${ctx }/js/pageBar/pageBarCommon.js?v=${version}"></script>
    <script src="${ctx }/template/hplus/js/jquery-ui.js?v=${version}"></script>
	<script src="${ctx }/js/custom/admin/order/list-order.js?v=${version}"></script>
			...
			for ( var i = 0; i < data.list.length; i++) {
				...
				if(null==order.listSplitSingle){
					...
					'<div class="col-sm-12 order-list-tr-head">' +
						'<div class="col-sm-2"><input type="checkbox" value="'+order.id+'" name="id" />&nbsp;&nbsp;' + order.userName + "(  "+order.userSerial+"  )"+'</div>' ;
						...
						if(order.state==5){
							html += '订单编号 : ' + order.orderNumber+deliverType+'<span style="margin-left:20px;">'+getIsSelfStr(order.orderItems[0].isSelf)+orderType+'</span></div>' ;
						} else{
						...
						if(order.orderType==3){
							html +='<div class="col-sm-3">订单类型 :虚拟订单</div>' +
							'</div>';
						}else{
							html +=	'<div class="col-sm-3">订单类型 : ' + order.typeStr + '</div>' +
							'</div>';
						}
						...
						'<div class="col-sm-12 order-list-tr-content">' ;
							...
							for(var index = 0 ; index < order.orderItems.length ; index++){
								html += '<div class="col-sm-12 text-left pull-left" style="line-height:30px"><img class="ver-T" src="' + order.orderItems[index].productPic + '"@120w_120h_1e_1c_75Q.jpg"><div class="ver-T content"><div><p>' + order.orderItems[index].productName + '</p></div></div></div>' ;
							}
							html += '</div>';
							...
							html +=
							'<div class="col-sm-1" style="display:table;height:100%"><div style="display:table-cell;vertical-align:middle;">' + order.receiveName +"<br>"+ order.receivePhone + '</div></div>' +
	...
	function closeRefund(id){
		layer.confirm("确认关闭售后？",{skin : 'layui-layer-molv',title : '系统提示'},function(layero,index){
  	    	 $.ajax({
	...
	function closeOrder(id){
		layer.confirm("确定关闭订单？",{skin : 'layui-layer-molv',title : '系统提示'},function(layero,index){
  	    	 $.ajax({
		...
		$.ajaxFileUpload({
			...
			success : function(data, status) {
				if (data.success) {
					...
					layer.alert(data.info,{ skin: 'layui-layer-molv',title :"系统提示" });
				}
			},
			error : function(data, status, e) {
				 layer.alert("导入文件失败！",{ skin: 'layui-layer-molv',title :"系统提示" });
			}
		});
	}
